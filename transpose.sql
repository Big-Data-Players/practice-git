...
CREATE TABLE GENDER_STAT_DB.HIVE_Q1 (CountryName varchar(50), IndicatorCode varchar(30), YearsByCountry INTEGER, DATA decimal(30,30) );
...
SET @STATEMENT = CONCAT(
    'INSERT INTO GENDER_STAT_DB.HIVE_Q1 (CountryName, IndicatorCode, YearsByCountry, Data)',
